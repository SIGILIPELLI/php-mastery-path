---
description: "Composer & Package Basics — Without a dependency manager you'd have to manually download library code, track which version you have, resolve conflicts…"
---
