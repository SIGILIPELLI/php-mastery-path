---
description: "Arrays — array_filter keeps the original keys, which often leaves gaps in numeric indexing — call array_values() afterward if you need a clean, re-indexed…"
---
