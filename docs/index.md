...
`<?php echo` to production-shaped, master-level engineering — with runnable
...
| [Level 3 · Advanced](level-3/index.md) | APIs, security, patterns | 9 topics + 1 project |
...
- Every topic page has runnable code snippets — copy them into a local `.php`
  file and run with `php` or `php -S localhost:8000`, or paste into your IDE.
